...
exports.getDistances = async (req, res, next) => {
  try {
    // Extract `latlng` and `unit` from request parameters
    ...
    // Determine the multiplier for converting distances
    ...
    const distances = await Tour.aggregate([
      {
        $geoNear: {
          ...
          distanceMultiplier: multiplier, // Converts distance to mi/km
          spherical: true,
        },
      },
      {
